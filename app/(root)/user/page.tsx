    ...
    <div className="pt-2 flex flex-col items-center">
      ...
      <div className="w-full h-[400px] ">
        <Image
          ...
          width={144}
          height={144}
          className="absolute top-[236.17px] left-[-19px] "
          alt={""}
        />
        <Image
          ...
          width={328}
          height={249}
          className="absolute top-[290px] left-[360px] "
          alt={""}
        />
        <Image
          ...
          width={78}
          height={88}
          className="absolute top-[456px] left-[216px] "
          alt={""}
        />
        <Image
          ...
          width={277}
          height={115}
          className="absolute top-[350px] left-[720px] "
          alt={""}
        />
        <Image
          ...
          width={255}
          height={80}
          className="absolute top-[450px] left-[814px] "
          alt={""}
        />
        <Image
          ...
          width={103}
          height={67}
          className="absolute top-[520px] left-[762px] "
          alt={""}
        />
        <Image
          src="/icons/import2/vector 3.svg"
          width={379.0000182066629}
          height={196.00000941558292}
          className="absolute top-[139.79px] left-[1237px] "
          alt={""}
        />
        <Image
          ...
          className="absolute top-[344.15px] left-[252px] "
          alt={""}
        />
        <Image
          src="/icons/import2/Polygon 16.svg"
          width={36.68558451201072}
          height={41.848971569732285}
          className="absolute top-[344.15px] rotate-[15deg] left-[1147px] "
          alt={""}
        />
        <Image
          ...
          className="absolute top-[438px] left-[1397.51px] "
          alt={""}
        />
        <Image
          ...
          className="absolute top-[466px] left-[82.58px] "
          alt={""}
        />
      </div>
