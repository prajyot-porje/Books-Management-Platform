...
const Page = () => {
    ...
    const fetchBooks = async () => {
      ...
      try {
        const response = await axios.get(
          "/api/books/getBooks?status=all books"
        );
  ...
  // Filter books based on search query (by title, author, or ISBN)
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50 min-h-screen">
      ...
      <motion.div
        ...
        className="pt-8 pb-4 z-10 w-full max-w-4xl mx-auto px-4"
      >
      ...
      {/* If searching, display only search results */}
      {searchQuery ? (
          ...
          {filteredBooks.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredBooks.map((book, index) => (
                ...
                >
                  <BookModal isAdmin={false} section={book} />
                </motion.div>
              ))}
            </div>
          ) : (
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    <Link
                      href="/user/allbooks"
                      className="text-sm text-blue-700 pr-4 justify-center flex items-center"
                    >
                      View All
